    ...
    <head>
      ...
      <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
          ...
          <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
              <ul class="list-reset lg:flex justify-end flex-1 items-center">
                <li class="mr-3">
                  <a id="navLogin1" class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Faculty Staff</a>
                </li>
                <li class="mr-3">
                  <a id="navLogin2" class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">SRAD Staff</a>
                </li>
              </ul>
              <a
                href="{{ route('login') }}"
        ...
        <div class="pt-24">
          <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              <p class="uppercase tracking-loose w-full">Want apply to our campus?</p>
              <h1 class="my-4 text-5xl font-bold leading-tight">
                Start your application here!
              </h1>
              <p class="leading-normal text-2xl mb-8">
                with our smart system easier for you to start your education!
              </p>
            ...
            <div class="flex flex-wrap">
              <div class="w-5/6 sm:w-1/2 p-6">
                ...
                <p class="text-gray-600 mb-8">
                  <b>Engineering the Future</b>
                  <br />
                  01st July marks the dawn of a new era of UTM as it completes a major and brave transformation to face the future.
                  <br />
                  <br />
                </p>
              </div>
        ...
        <section class="bg-white border-b py-8">
          <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
              Join With Our <span class="gradient text-white rounded-xl px-2">Active</span> Student
            </h1>
            <div class="w-full mb-4">
              <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
            </div>
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                  <p class="w-full font-bold text-black text- md:text-2xl text-center pt-24 px-6">
                    Undergraduate
                  </p>
                </a>
              </div>
      ...
      -->
        <script>
          ...
          var navLogin1 = document.getElementById("navLogin1");
          var navLogin2 = document.getElementById("navLogin2");
          ...
          document.addEventListener("scroll", function () {
            ...
            if (scrollpos > 10) {
              ...
              navLogin1.classList.remove("text-white");
              navLogin2.classList.remove("text-white");
              navLogin1.classList.add("text-black");
              navLogin2.classList.add("text-black");
              ...
              navLogin1.classList.add("text-white");
              navLogin2.classList.add("text-white");
              navLogin1.classList.remove("text-black");
              navLogin2.classList.remove("text-black");
            }
          });
        </script>
        <script>
